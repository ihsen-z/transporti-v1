      ...
      <main className="flex-1 pt-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={stat.label} className="group">
                  ...
                  <div className="text-3xl md:text-4xl font-bold text-primary-800 mb-1 group-hover:text-accent-600 transition-colors">
                    {stat.value}
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={item.step}
                  className={`${item.bgColor} rounded-2xl p-8 relative overflow-hidden group hover:shadow-lg transition-shadow`}
                >
                  <div
                    className={`absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br ${item.color} rounded-full opacity-10 group-hover:opacity-20 transition-opacity`}
                  ></div>
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center text-white font-bold text-xl mb-5`}
                  >
                    {item.step}
                  </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-8 hover-lift">
                ...
                <p className="text-neutral-700">
                  Système d&apos;escrow intégré. Votre argent est protégé
                  jusqu&apos;à la livraison confirmée.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-accent-50 to-accent-100 rounded-xl p-8 hover-lift">
                ...
                <p className="text-neutral-700">
                  Suivez votre colis en temps réel et communiquez directement
              ...
              <div className="bg-gradient-to-br from-cta-50 to-cta-100 rounded-xl p-8 hover-lift">
                ...
                <p className="text-neutral-700">
                  Réseau de transporteurs professionnels pour des livraisons
                  rapides dans tout le pays.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-r from-primary-700 to-primary-900">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-primary-100 mb-8">
              Rejoignez Transporti — la plateforme de confiance pour vos envois
              en Tunisie
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                ...
                className="inline-block bg-white/10 hover:bg-white/20 text-white font-semibold px-10 py-4 rounded-lg border border-white/30 text-lg transition-all"
              >
