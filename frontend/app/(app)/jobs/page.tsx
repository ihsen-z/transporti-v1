    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-neutral-900 mb-2">Mes Transports</h1>
                    <p className="text-neutral-600">Gérez et suivez tous vos transports</p>
                </div>
                <button className="bg-primary-700 hover:bg-primary-800 text-white font-semibold px-6 py-3 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none"
                        />
                    </div>
                    <div className="flex gap-2">
                        <select className="px-4 py-2 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none bg-white">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-white rounded-lg border border-neutral-200 p-4 text-center">
                    <p className="text-2xl font-bold text-orange-600">{jobs.filter(j => j.status === 'PENDING').length}</p>
                    <p className="text-sm text-neutral-600">En attente</p>
                </div>
                <div className="bg-white rounded-lg border border-neutral-200 p-4 text-center">
                    <p className="text-2xl font-bold text-accent-600">{jobs.filter(j => j.status === 'IN_PROGRESS').length}</p>
