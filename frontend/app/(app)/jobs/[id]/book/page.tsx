...
const MOCK_OFFER = {
    ...
    message: 'Je peux transporter votre colis le jour même. Véhicule disponible immédiatement.',
};
            ...
            <div className="p-6 lg:p-8 max-w-2xl mx-auto">
                <div className="bg-white rounded-2xl border border-neutral-100 p-12 text-center">
                    ...
                    <p className="text-neutral-500 mb-8 max-w-md mx-auto">
                        Votre transporteur a été notifié. Vous pouvez suivre l'avancement de votre mission
                    ...
                    <div className="bg-neutral-50 rounded-xl p-4 mb-8 text-left space-y-2">
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="font-mono font-medium text-neutral-900">TRN-{job.id.toString().padStart(6, '0')}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-neutral-500">Mode de paiement</span>
                            <span className="font-medium text-neutral-900">
                                {paymentMethod === 'DIGITAL' ? 'Paiement digital (Escrow)' : 'Paiement à la livraison'}
                            </span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-neutral-500">Montant total</span>
                            <span className="font-semibold text-blue-600">{offer.total_price.toFixed(2)} TND</span>
                        </div>
                    </div>
    ...
    return (
        <div className="p-6 lg:p-8 max-w-5xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <h1 className="text-2xl font-bold text-neutral-900">Finaliser la réservation</h1>
                <p className="text-neutral-500 mt-1">Vérifiez les détails et choisissez votre mode de paiement.</p>
            </div>
                ...
                {(['review', 'payment', 'confirm'] as BookingStep[]).map((s, i) => {
                    ...
                    return (
                        <React.Fragment key={s}>
                            {i > 0 && <div className={`flex-1 h-0.5 ${isDone ? 'bg-blue-500' : 'bg-neutral-200'}`} />}
                            <div className="flex items-center gap-2">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold
                                    ${isDone ? 'bg-blue-500 text-white' : isActive ? 'bg-blue-100 text-blue-600 ring-2 ring-blue-500' : 'bg-neutral-100 text-neutral-400'}`}>
                                    {isDone ? <CheckCircle2 className="w-4 h-4" /> : i + 1}
                                </div>
                                <span className={`text-sm font-medium hidden sm:block ${isActive ? 'text-neutral-900' : 'text-neutral-400'}`}>
                                    {labels[i]}
                                </span>
                            </div>
                        </React.Fragment>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div className="lg:col-span-3 space-y-6">
                        ...
                        <>
                            ...
                            {offer.message && (
                                <div className="bg-white rounded-2xl border border-neutral-100 p-6">
                                    <h3 className="text-sm font-semibold text-neutral-900 mb-2">Message du transporteur</h3>
                                    <p className="text-sm text-neutral-600 italic">"{offer.message}"</p>
                                </div>
                            )}
                            <button
                                onClick={() => setStep('payment')}
                                className="w-full bg-blue-600 text-white py-3.5 rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20">
                    ...
                    {step === 'confirm' && (
                        <>
                            <div className="bg-white rounded-2xl border border-neutral-100 p-6">
                                <h3 className="text-lg font-semibold text-neutral-900 mb-4">Confirmation finale</h3>
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-between text-sm py-2 border-b border-neutral-50">
                                        ...
                                        <span className="text-neutral-900 font-medium">{offer.transporter_name}</span>
                                    </div>
                                    <div className="flex justify-between text-sm py-2 border-b border-neutral-50">
                                        <span className="text-neutral-500">Mode de paiement</span>
                                    ...
                                    <div className="flex justify-between text-base py-2 font-bold">
                                        ...
                                        <span className="text-blue-600">{offer.total_price.toFixed(2)} TND</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
                                ...
                                <a href="#" className="underline font-medium">conditions générales</a> de Transporti.
                            </div>
                ...
                <div className="lg:col-span-2 space-y-4 hidden lg:block">
                    <div className="bg-white rounded-2xl border border-neutral-100 p-6 sticky top-24">
                        <h3 className="text-sm font-semibold text-neutral-900 mb-4">Votre commande</h3>
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex justify-between">
                                <span className="text-neutral-500">Transporteur</span>
                                <span className="font-medium text-neutral-900">{offer.transporter_name}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-neutral-500">Date</span>
                                <span className="font-medium text-neutral-900">
                                    {new Date(job.scheduled_time).toLocaleDateString('fr-TN', { day: 'numeric', month: 'short' })}
                                </span>
                            </div>
