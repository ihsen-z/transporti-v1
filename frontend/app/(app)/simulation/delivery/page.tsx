    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {!isStarted ? (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-12 text-center">
          <div className="w-20 h-20 bg-brand-600/10 text-brand-600 rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <p className="text-neutral-600 max-w-2xl mx-auto mb-8">
            This guided simulation will walk you through a complete delivery
            workflow as a real user. You&apos;ll experience job creation, status
            tracking, notifications, and completion. All data is mock and
            isolated from production.
          </p>
          <div className="bg-brand-600/5 border border-brand-600/20 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
            <h3 className="font-semibold text-brand-800 mb-3">
              What you&apos;ll experience:
            </h3>
            <ul className="text-left text-sm text-brand-700 space-y-2">
          ...
          <button
            ...
            className="bg-brand-700 hover:bg-brand-800 text-white font-semibold px-8 py-4 rounded-lg shadow-lg transition-colors flex items-center gap-2 mx-auto"
          >
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                {deliveryWorkflowSteps.map((_, i) => (
                  <div
                    ...
                    className={`flex-1 h-2 rounded-full transition-colors ${
                      i <= currentStep ? "bg-brand-600" : "bg-neutral-200"
                    }`}
                  />
                ))}
              </div>
            ...
            {/* Current Step */}
            <div className="bg-white rounded-xl shadow-sm border-2 border-brand-600/30 p-8">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-12 h-12 bg-brand-600/10 text-brand-600 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              {currentStepData.highlights && (
                <div className="bg-accent-50 border border-accent-200 rounded-lg p-4 mb-6">
                  <h4 className="font-semibold text-accent-900 mb-2 text-sm">
                    Key Elements:
                  </h4>
                  <ul className="space-y-1">
                    {currentStepData.highlights.map((highlight, i) => (
                      <li
                        key={i}
                        className="text-sm text-accent-800 flex items-center gap-2"
                      >
              ...
              <div className="space-y-3">
                {currentStep === 0 && (
                  <button
                    onClick={() => goToRoute("/")}
                    className="w-full bg-brand-700 hover:bg-brand-800 text-white font-semibold px-6 py-3 rounded-lg transition-colors flex items-center justify-center gap-2"
                  >
                    Go to Home Page
                ...
                {currentStep === 3 && (
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full bg-brand-600 hover:bg-brand-700 text-white font-medium px-4 py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    {jobStatus === "COMPLETED" && (
                      <button
                        onClick={nextStep}
                        className="w-full bg-brand-700 hover:bg-brand-800 text-white font-semibold px-6 py-3 rounded-lg transition-colors mt-4"
                      >
        ...
        <div className="fixed inset-0 bg-black/50 z-modal-backdrop flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            ...
            <button
              ...
              className="w-full bg-brand-700 hover:bg-brand-800 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
            >
        ...
        <div className="fixed inset-0 bg-black/50 z-modal-backdrop flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-neutral-600">
                You&apos;ve successfully completed the delivery workflow
                simulation
              </p>
            </div>
