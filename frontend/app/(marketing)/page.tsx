                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-blue-500 rounded-2xl transform rotate-3"></div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3 bg-white/20 rounded-lg p-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm text-blue-100">Paiement protégé</div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3 bg-white/20 rounded-lg p-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm text-blue-100">Localisation GPS</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-8 hover:shadow-lg transition-shadow">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3">Suivi en direct</h3>
                            <p className="text-gray-700">
