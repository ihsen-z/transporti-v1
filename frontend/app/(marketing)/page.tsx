          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-6 leading-tight">
                ...
                <br />
                <span className="text-green-400">Simple, rapide, fiable.</span>
              </h1>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold px-8 py-3 rounded-lg border border-white/30"
                >
                  En savoir plus
                </button>
              </div>
            ...
            <div className="hidden md:block">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-primary-500 rounded-2xl transform rotate-3"></div>
                <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 transform -rotate-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-neutral-700">
                Suivez votre colis en temps réel avec la géolocalisation GPS de
                nos transporteurs.
              </p>
            </div>
