...
export const fr = {
  ...
  landing: {
    ...
    // Pivot « Return Trips First » — signatures officielles (vision v1.0)
    pivotHeroTitle1: "Chaque retour à vide",
    pivotHeroTitle2: "est une opportunité.",
    pivotHeroDesc:
      "Transporteurs : gagnez plus avec les trajets que vous effectuez déjà. Clients : trouvez un transporteur fiable au meilleur prix, déjà en route sur votre trajet.",
    pivotCtaTransporter: "Publier mon trajet retour",
    pivotCtaClient: "Trouver un trajet",
    pivotTrustLine:
      "✓ Paiement sécurisé par escrow · ✓ Transporteurs vérifiés · ✓ Commission réduite sur les retours",
  ...
  dashboard: {
    ...
    clientCTAFirst: "Un transporteur passe peut-être déjà par chez vous",
    clientCTAFirstDesc:
      "Cherchez d'abord un trajet retour sur votre corridor : moins cher, plus rapide. Sinon, publiez votre demande en quelques clics.",
    findTripCTA: "Trouver un trajet",
    publishAd: "Publier une annonce",
  ...
  returnTrips: {
    ...
    noTripsDesc:
      "Aucun trajet ne correspond à votre recherche pour le moment. Publiez votre demande — les transporteurs vous feront des offres — ou créez une alerte pour être prévenu.",
    publishFallback: "Publier une demande pré-remplie",
    createAlert: "M'alerter sur ce corridor",
    alertCreated:
      "Alerte créée ! Vous serez notifié dès qu'un trajet compatible est publié.",
    alertError: "Impossible de créer l'alerte.",
  ...
  offerForm: {
    ...
    priceInvalid: "Le tarif doit être supérieur à 0.",
    priceTooHigh: "Le tarif ne peut pas dépasser 100 000 TND.",
  ...
  myOfferCard: {
    ...
    yourNet: "Votre gain net",
    commission: "Commission plateforme",
    clientTotal: "Prix total (payé par le client)",
    expiresOn: "Expire le",
    viewMyOffers: "Voir mes offres",
    resubmitNotAllowed:
      "Une seule offre par mission est autorisée. Cette offre n'est plus active, mais vous ne pouvez pas en soumettre une nouvelle sur cette mission.",
    withdrawSuccess: "Offre retirée avec succès.",
    withdrawError: "Impossible de retirer cette offre.",
  },
  ...
  offerStatusCard: {
    ...
    forClient: "pour {name}",
    netEarning: "Votre gain net",
    commission: "Commission",
    clientTotal: "Prix client",
    expiresIn: "Expire dans {hours}h",
  ...
  verify: {
    ...
    docExpired: "Expiré",
    docExpiresSoon: "Expire bientôt, le",
  ...
  newJob: {
    ...
    matchBannerTitle:
      "{count} trajet(s) retour disponible(s) sur ce corridor !",
    matchBannerDesc:
      "Un transporteur passe déjà par là — réservez son retour, c'est moins cher et plus rapide.",
    matchBannerCta: "Voir les trajets",
  ...
  jobDetail: {
    ...
    sendRequestTitle: "Demande de transport",
    sendRequestCta: "Envoyer la demande",
    requestDescriptionLabel: "Que voulez-vous transporter ?",
    requestDescriptionPlaceholder:
      "Ex : un frigo et 5 cartons, environ 120 kg...",
    requestDescriptionRequired: "Décrivez ce que vous voulez transporter.",
    requestSent: "Demande envoyée ! Le transporteur va vous répondre.",
    requestCancelled: "Demande annulée.",
    counterAccepted:
      "Contre-proposition acceptée — finalisez le paiement pour démarrer.",
    myRequestTitle: "Votre demande sur ce trajet",
    myRequestPending: "En attente de réponse du transporteur",
    myRequestAccepted: "Acceptée — finalisez le paiement",
    myRequestCountered: "Contre-proposition reçue",
    counterProposal: "Le transporteur propose {price}.",
    acceptCounter: "Accepter",
    ...
    pinRequired: "Saisissez les 4 chiffres du code de livraison du client.",
    milestoneSaved: "Étape enregistrée.",
    milestoneArrived: "Je suis arrivé au chargement",
    milestoneLoaded: "Chargé — je suis en route",
    eventArrivedPickup: "Arrivé au point de chargement",
    eventLoaded: "Chargé — en route",
    eventDelivered: "Livré",
    deliveryPinLabel: "Votre code de livraison",
    deliveryPinHint: "Donnez ces 4 chiffres au transporteur à la réception.",
    podPinInputLabel: "Code de livraison (4 chiffres)",
    podPhotoLabel: "Photo de preuve (optionnel)",
  ...
  tripOwner: {
    title: "Mon trajet retour",
    statusPublished: "Publié",
    statusExpired: "Expiré",
    edit: "Modifier",
    delete: "Supprimer",
    deleteTitle: "Supprimer le trajet retour",
    deleteDesc:
      "Le trajet sera retiré de la recherche et les demandes en attente seront refusées. Cette action est irréversible.",
    deleteCta: "Supprimer le trajet",
    deleteSuccess: "Trajet retour supprimé.",
    editSuccess: "Trajet retour mis à jour.",
    capacityLabel: "Capacité disponible",
    priceLabel: "Prix indicatif (TND)",
    instantBookingLabel: "Autoriser la réservation immédiate",
    save: "Enregistrer",
    saving: "Enregistrement...",
    requestsTitle: "Demandes reçues",
    noRequests:
      "Aucune demande pour le moment. Les clients de votre corridor verront ce trajet dans leur recherche.",
    accept: "Accepter",
    counter: "Contre-proposer",
    sendCounter: "Envoyer",
    counterPlaceholder: "Nouveau prix (TND)",
    acceptSuccess: "Demande acceptée — le client va finaliser le paiement.",
    rejectSuccess: "Demande refusée.",
    counterSuccess: "Contre-proposition envoyée.",
    actionError: "Action impossible. Veuillez réessayer.",
    awaitingClient: "En attente de la réponse du client",
    payDigital: "Paiement digital",
    payCod: "Espèces à la livraison",
    reqPending: "En attente",
    reqAccepted: "Acceptée",
    reqRejected: "Refusée",
    reqCountered: "Contre-proposée",
    reqCancelled: "Annulée",
    reqExpired: "Expirée",
  },
  ...
  returnTrip: {
    ...
    instantBookingLabel: "Autoriser la réservation immédiate",
    instantBookingHint:
      "Un client pourra réserver directement sans votre accord préalable. Désactivé, vous recevez des demandes que vous acceptez, refusez ou contre-proposez.",
    reverseMatchTitle:
      "demande(s) de transport déjà ouverte(s) sur votre corridor !",
    reverseMatchNoBudget: "Budget non précisé",
    reverseMatchHint:
      "Faites une offre dès maintenant — votre retour est déjà monétisable.",
  ...
  admin: {
    ...
    dashboard: {
      ...
      active: "actifs",
      pending: "en attente",
      commission: "Commissions réelles",
      pivotSectionTitle: "Pivot — Retours à vide (North Star)",
      kpiNsm: "Km à vide transformés",
      kpiNsmSub: "NSM — missions retours terminées",
      kpiCo2: "CO₂ évité",
      kpiTripsActive: "Trajets retour actifs",
      kpiTripsBooked: "réservés au total",
      kpiFillRate: "Taux de remplissage",
      kpiExtraRevenue: "Revenus additionnels : {amount}",
      corridorA1Title: "Liquidité corridor A1 (Tunis – Sousse – Sfax – Gabès)",
