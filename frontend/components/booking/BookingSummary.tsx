...
import { Truck, Package, MapPin, Calendar, User, Star, ShieldCheck } from 'lucide-react';
    ...
    return (
        <div className="bg-white rounded-2xl border border-neutral-100 overflow-hidden">
            <div className="px-6 py-4 border-b border-neutral-100 bg-neutral-50">
                <h3 className="text-lg font-semibold text-neutral-900">Récapitulatif de la commande</h3>
            </div>
            ...
            <div className="p-6 space-y-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-sm font-medium text-neutral-900">
                            {job.job_type === 'TRANSPORT' ? 'Transport de marchandises' : 'Déménagement'}
                        </p>
                ...
                <div className="bg-neutral-50 rounded-xl p-4 space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-neutral-900">{job.pickup_address}</p>
                        </div>
                    </div>
                    <div className="ml-3 border-l-2 border-dashed border-neutral-200 h-4" />
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-neutral-900">{job.dropoff_address}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <p className="text-sm font-medium text-neutral-900">{offer.transporter_name}</p>
                        ...
                        {offer.transporter_rating && (
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs text-neutral-500">{offer.transporter_rating}/5</span>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                        ...
                        <span className="text-neutral-900 font-medium">{offer.total_price.toFixed(2)} TND</span>
                    </div>
                    <div className="flex justify-between text-sm">
                        <span className="text-neutral-600">Commission plateforme ({((offer.commission_rate || 0.15) * 100).toFixed(0)}%)</span>
