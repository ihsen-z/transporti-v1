...
const demoRoles: Exclude<UserRole, "guest">[] = [
  "client",
  "transporter",
  "admin",
];
    ...
    <div className="fixed bottom-4 right-4 z-50">
      <div className="relative">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-neutral-800 text-white rounded-lg shadow-lg hover:bg-neutral-700 transition-colors"
        >
              ...
              {demoRoles.map((r) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    <span
                      className={`px-2 py-0.5 rounded text-xs ${roleColors[r]}`}
                    >
                      {roleLabels[r]}
                    </span>
                  </div>
