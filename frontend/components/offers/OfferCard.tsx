        ...
        <div className="bg-white border rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center overflow-hidden">
                        {offer.transporter_avatar ? (
                            <img src={offer.transporter_avatar} alt={offer.transporter_name} className="w-full h-full object-cover" />
                        ) : (
                ...
                <div className="text-right">
                    <p className="text-2xl font-bold text-blue-600">{offer.total_price} TND</p>
