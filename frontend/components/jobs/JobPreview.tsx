...
import { MapPin, Calendar, Package, Truck, Home } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-white/20 rounded-lg">
                        {isTransport ? <Truck className="w-6 h-6" /> : <Home className="w-6 h-6" />}
                    </div>
                    <div>
                        <h3 className="font-bold text-xl">
                            {isTransport ? 'Transport de Marchandises' : 'Déménagement'}
                        </h3>
                        <p className="text-blue-100 text-sm">Récapitulatif de votre demande</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-xs text-blue-200 uppercase font-semibold">Arrivée</p>
                ...
                {isTransport ? (
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div className="bg-gray-50 p-3 rounded-lg">
                            ...
                            <span className="font-medium">{data.specifications?.weight || '-'} kg</span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                <p className="text-sm text-orange-800">
                    <strong>Note :</strong> Une fois publiée, votre demande sera visible par les transporteurs vérifiés.
                    Vous recevrez des offres sous forme d'enchères inversées.
                </p>
            </div>
        </div>
    );
