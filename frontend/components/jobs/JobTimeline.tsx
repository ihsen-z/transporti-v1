...
export default function JobTimeline({ status }: JobTimelineProps) {
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
            <h3 className="text-lg font-bold text-neutral-900 mb-6">Progression du transport</h3>
                                ...
                                return (
                                    <div key={step.id} className="flex items-start">
                                        ...
                                        <div className="flex flex-col items-center mr-4">
                                            ...
                                            <div
                                                className={`
                                                    ...
                                                    ${isCompleted ? 'bg-accent-500 text-white' : ''}
                                                    ${isCurrent ? 'bg-primary-600 text-white ring-2 ring-primary-100' : ''}
                                                    ${isUpcoming ? 'bg-neutral-200 text-neutral-400' : ''}
                                                `}
                                            >
                                                {isCompleted ? (
                                        ...
                                        <div className={`pt-1 pb-6 ${isLast ? 'pb-0' : ''}`}>
                                            ...
                                            {isCurrent && (
                                                <p className="text-xs text-primary-500 mt-0.5">Étape actuelle</p>
                                            )}
                                        </div>
                                    </div>
                                );
